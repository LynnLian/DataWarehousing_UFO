...
of the art concerning our problem. The material presented in this section is based on online information (see \cite{scdkimball,wikiscd} and \cite{wikitempdb}) as well as 
...
\begin{enumerate}
	...
	\item Describe the necessary tools for the solution
	\item A DWH layout
	\item An Analysis using Reporting or LibreOffice.
\end{enumerate}
 This concept must now be put into practice.
