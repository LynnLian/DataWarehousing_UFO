...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
Based on the data resourse from XXX and the data processing by CRISP-DM, a fact shows us that XXXXXXXXX
\end{abstract}
...
e.g. If there are popular ufo shapes per country or if
the number of ufo sightings depends on daytime or
nighttime.(XXXXXXXXX To see whether we want to have more )

\subsection{Scenario} \label{subsec:scenario}
The data source has totally 11 columns which covers the discovering time, location, shapes, duration and so on. As our goal is to find out the popular shapes per country and the number of ufo sightings depending on daytime or nighttime, we need to creates a data warehouse contains at least the information of shapes, country, time category.
...
of the art concerning our problem. The material presented in this section is based on online information (see \cite{scdkimball,wikiscd} and \cite{wikitempdb}) (placeholder XXXXXXXXXXX see how to add the link in .bib -->https://www.kaggle.com/NUFORC/ufo-sightings)
...
\begin{itemize}
  ...
  We would like to see some relationship between the sighn and season, daytime.In other word, we need difference dimentional. So we will create "new" data by using alsorithms:
  \begin{itemize}
...
Data-Mining: Apply Algorithm 
Analytics: Create a report with (aggregated) data, for example using Pivot tables 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Evaluation} \label{sec:Evaluation}
Did we reach the goals??? Talk about how we know we reach our goal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Deployment} \label{sec:Deployment}
To talke about how we make result available and what is the result
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
